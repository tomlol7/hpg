...
async function analyze() {
  ...
  if (
    confirm(
      `The program thinks you are ${sex} with ${(detection.genderProbability * 100).toFixed(2)}% confidence. Is this correct?`
    )
  ) {
...
(async () => {
  // ✅ use relative paths so it works on GitHub Pages (/hpg/) and locally
